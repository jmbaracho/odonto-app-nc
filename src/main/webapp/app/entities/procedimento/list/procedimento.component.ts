...
import { EntityArrayResponseType, ProcedimentoService } from '../service/procedimento.service';
...
export class ProcedimentoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProcedimento): number => this.procedimentoService.getProcedimentoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.procedimentos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IProcedimento[] | null): IProcedimento[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.procedimentoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
