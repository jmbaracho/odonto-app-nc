...
describe('Procedimento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'procedimento', component: ProcedimentoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.procedimentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to procedimentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProcedimentoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProcedimentoIdentifier).toHaveBeenCalledWith(entity);
