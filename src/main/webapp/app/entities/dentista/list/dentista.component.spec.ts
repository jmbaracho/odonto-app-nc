...
describe('Dentista Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dentista', component: DentistaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dentistas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to dentistaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDentistaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDentistaIdentifier).toHaveBeenCalledWith(entity);
